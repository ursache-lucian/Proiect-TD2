...
function Profile({ user, onLogout }) {
  ...
  // Starea pentru CV
  const [fisierCV, setFisierCV] = useState(null);
            ...
            <div className="card border-0 shadow-sm mb-4" style={{ borderRadius: "16px" }}>
              ...
              <div className="card-body p-4">
                ...
                {!editMode && (
                  <>
                    <div className="mb-3">
                      <label className="form-label fw-medium text-muted" style={{ fontSize: "0.85rem" }}>
                        {user.role === "student" ? "FACULTATE" : "COMPANIE"}
                      </label>
                      <p className="mb-0" style={{ color: "#374151" }}>
                        {profil?.faculty || <span className="text-muted fst-italic">Necompletat</span>}
                      </p>
                    </div>

                    <div className="mb-3">
                      <label className="form-label fw-medium text-muted" style={{ fontSize: "0.85rem" }}>DESPRE</label>
                    ...
                    {/* Abilitatile — doar pentru studenti */}
                    {user.role === "student" && (
                      <div className="mb-4">
                  ...
                  <>
                    <div className="mb-3">
                      <label className="form-label fw-medium" style={{ color: "#374151" }}>
                        {user.role === "student" ? "Facultate" : "Nume companie"}
                      </label>
                      <input
                        type="text" name="faculty" className="form-control"
                        placeholder={user.role === "student" ? "ex: Facultatea de Informatică" : "ex: TechCorp SRL"}
                    ...
                    <div className="mb-3">
                      <label className="form-label fw-medium" style={{ color: "#374151" }}>Despre</label>
                      <textarea
                    ...
                    {/* Campul de abilitati — doar pentru studenti */}
                    {user.role === "student" && (
                      <div className="mb-4">
